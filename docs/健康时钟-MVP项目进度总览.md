...
**更新时间：2026-04-25（第九轮 Apple 登录与语音输入）**
...
一句话总结：P0 三个阻断性问题（文档无法查看、新用户无引导、导航栈不一致）已全部修复；OCR 链路完整修复；AI 摘要展示不再显示英文 key 和空字段；OCR 候选提醒可确认创建；Apple 登录与语音输入已纳入首版；MVP 核心功能已达可体验状态。
