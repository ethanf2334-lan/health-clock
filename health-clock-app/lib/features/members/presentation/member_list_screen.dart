...
class MemberListScreen extends ConsumerWidget {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    trailing: IconButton(
                      ...
                      onPressed: () {
                        _showMemberOptions(context, ref, member.id);
                      },
                    ),
                    onTap: () {
                      // TODO: 导航到成员详情页
  ...
  void _showMemberOptions(BuildContext context, WidgetRef ref, String memberId) {
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () async {
                ...
                if (confirm == true) {
                  await ref.read(memberListProvider.notifier).deleteMember(memberId);
                }
              },
            ),
          ],
